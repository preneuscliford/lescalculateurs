...
const SIMULATOR_PATTERNS = {
  APL: {
    patterns: ['APL estimee', 'aide au logement', 'montant APL', 'apl_estimee', 'apl-brute', 'loyer plafond'],
    officielUrl: 'https://www.caf.fr',
    officielText: 'CAF',
    faqQuestion: 'Comment obtenir le montant exact de mon APL ?',
    faqAnswer: 'Utilisez le simulateur officiel de la CAF pour connaitre votre montant definitif d aide au logement.'
  },
  IMPOT: {
    patterns: ['Impot a payer', 'reduction d impot', 'montant IR', 'irBrut', 'impot-revenu', 'tranche imposition'],
    ...
    faqAnswer: 'Utilisez le simulateur officiel des impots pour connaitre votre montant d impot definitif.'
  },
  NOTAIRE: {
    patterns: ['Total frais de notaire', '% du prix', 'emoluments', 'droits mutation', 'frais-notaire', 'total-notaire'],
    ...
    faqAnswer: 'Consultez un notaire ou utilisez les outils officiels des Notaires de France pour une estimation precise.'
  },
  IK: {
    patterns: ['Indemnites kilometriques', 'bareme IK', '0,502', 'ik-calculator', 'frais kilometriques'],
    officielUrl: 'https://www.impots.gouv.fr',
    officielText: 'impots.gouv.fr',
    faqQuestion: 'Quel est le bareme officiel des indemnites kilometriques ?',
    faqAnswer: 'Consultez le bareme fiscal officiel sur impots.gouv.fr pour connaitre les taux applicables a votre situation.'
  },
  RSA: {
    patterns: ['montant RSA', 'RSA estime', 'revenu solidarite', 'rsa-montant', 'montantEstime'],
    officielUrl: 'https://www.caf.fr',
    officielText: 'CAF',
    faqQuestion: 'Comment connaitre le montant exact de mon RSA ?',
    faqAnswer: 'Utilisez le simulateur officiel de la CAF pour connaitre votre montant definitif de RSA.'
  },
  PRIME: {
    patterns: ['Prime estimee', 'Prime d activite', 'prime-activite', 'montant prime'],
    officielUrl: 'https://www.caf.fr',
    officielText: 'CAF',
    faqQuestion: 'Comment connaitre le montant exact de ma Prime d activite ?',
    faqAnswer: 'Utilisez le simulateur officiel de la CAF pour connaitre votre montant definitif de Prime d activite.'
  },
  SALAIRE: {
    patterns: ['Salaire net', 'brut net', 'salaire-calculator', 'net-apres-impot'],
    officielUrl: 'https://www.impots.gouv.fr',
    officielText: 'impots.gouv.fr',
    faqQuestion: 'Comment calculer mon salaire net exact ?',
    faqAnswer: 'Utilisez les simulateurs officiels pour connaitre votre salaire net apres deduction des cotisations et impots.'
  },
  PRET: {
    patterns: ['Mensualite', 'capacite emprunt', 'taux endettement', 'pret-calculator', 'mensualite-pret'],
    ...
    faqAnswer: 'Consultez un etablissement bancaire ou un courtier pour une simulation de pret precise.'
  },
  TAXE: {
    patterns: ['Taxe fonciere', 'montant taxe', 'taxe-calculator', 'valeur locative'],
    officielUrl: 'https://www.impots.gouv.fr',
    officielText: 'impots.gouv.fr',
    faqQuestion: 'Comment connaitre le montant exact de ma taxe fonciere ?',
    faqAnswer: 'Consultez votre avis d imposition ou contactez le centre des impots fonciers de votre commune.'
  },
  PLUSVALUE: {
    patterns: ['Plus-value', 'abattement', 'calcul plus-value', 'plusvalue-calculator'],
    officielUrl: 'https://www.impots.gouv.fr',
    officielText: 'impots.gouv.fr',
    faqQuestion: 'Comment calculer ma plus-value immobiliere exacte ?',
    faqAnswer: 'Consultez un notaire ou le site des impots pour un calcul precis de votre plus-value immobiliere.'
  }
};
...
function addStickyBanner(content, config) {
  ...
  const banner = '<div class="sticky-ymyl" role="alert" style="position:sticky;top:0;z-index:9999;background:#fff3cd;border:1px solid #ffc107;padding:12px 16px;text-align:center;font-size:14px;"><strong>⚠️ Estimation indicative.</strong> Montant definitif sur <a href="' + config.officielUrl + '" target="_blank" rel="noopener" style="color:#856404;text-decoration:underline;font-weight:bold;">' + config.officielText + '</a> ou <a href="/simulateur" style="color:#856404;text-decoration:underline;">simulateur officiel</a>.</div>';
...
function addOfficielButton(content, config) {
  ...
  const button = '<div class="ymyl-officiel-btn" style="text-align:center;margin:20px 0;"><a class="btn-officiel" href="' + config.officielUrl + '" target="_blank" rel="noopener" style="display:inline-block;background:#007bff;color:#fff;padding:12px 24px;border-radius:4px;text-decoration:none;font-weight:bold;">👉 Simulateur officiel ' + config.officielText + '</a><p style="font-size:12px;color:#666;margin-top:8px;">Pour un calcul definitif conforme aux baremes officiels</p></div>';
