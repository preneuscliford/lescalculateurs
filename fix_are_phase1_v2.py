...
# Lire le fichier et trouver exactement ce qu'on doit remplacer
# Utiliser bytes pour éviter les problèmes d'encodage
with open('src/pages/are.html', 'rb') as f:
    raw = f.read()

# Chercher le pattern avec l'apostrophe typographique (U+2019 en UTF-8 = \xe2\x80\x99)
...
# Ajouter la date après le H1 (pattern avec \r\n)
date_html = b'''</h1>
