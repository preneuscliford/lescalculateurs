...
function processFile(filePath) {
  ...
  const code = match[1].toUpperCase() === '2A' ? '2A' : 
               (match[1].toUpperCase() === '2B' ? '2B' : match[1]);
...
function main() {
  ...
  console.log(`  • "Droits réduits uniformisés" → formulation VEFA: ${fixes.uniformises} pages`);
  ...
  console.log(`  • Montants incohérents (15 828/4 618): ${fixes.montants} pages`);
