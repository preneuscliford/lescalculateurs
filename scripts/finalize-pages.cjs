...
function makeTableHtml(prices, ancienPct, neufPct, labelAlt = false) {
  ...
  const rows = prices
    ...
    .join("\n");
  return `<table>\n<thead><tr><th>Prix du bien</th><th>${ancienLabel}</th><th>Frais neuf</th><th>Economie</th></tr></thead>\n<tbody>\n${rows}\n</tbody>\n</table>`;
}
...
const overrides = {
  "06": {
    ...
    localAdvices: [
      ...
      "A Grasse, la CCPL rembourse 1 500 € de frais de notaire pour les primo-accedants < 30 ans.",
    ],
    localFaqs: [
      {
        q: "Les Monegasques doivent-ils verser une taxe additionnelle a Cannes ?",
        a: "Les regles fiscales varient selon la residence principale; rapprochez-vous du service fiscal de la commune pour confirmation.",
      },
      {
        q: "Existe-t-il une surtaxe " residence secondaire " a Nice ?",
        a: "Certaines communes appliquent des majorations pour les residences secondaires : renseignez-vous aupres de la mairie.",
      },
    ],
    sources: [
  ...
  "01": {
    ...
    localAdvices: [
      "Dans le Pays de Gex, demandez la ristourne " frontalier " de 0,20 % appliquee par trois etudes.",
      "A Oyonnax, la VEFA dans l'eco-quartier de la Plaine de l'Yerres exonere de taxe d'amenagement.",
    ],
    localFaqs: [
      {
        q: "Le permis G frontalier reduit-il les frais de notaire dans le Pays de Gex ?",
        a: "Certaines mesures facilitent les acquisitions frontalieres; consultez une etude locale pour details.",
      },
      {
        q: "Faut-il un notaire suisse pour une donation transfrontaliere ?",
        a: "Pour des donations impliquant la Suisse, il est recommande de consulter un notaire ou avocat fiscaliste competent en droit international.",
      },
    ],
    sources: [
      { label: "INSEE Auvergne-Rhone-Alpes", url: "https://insee.fr" },
      { label: "DGFiP - DVF 2024", url: "https://data.dvf.etalab.gouv.fr" },
      { label: "Notaires.fr", url: "https://notaires.fr" },
      { label: "Bareme 2025 - CSN", url: "https://notaires.fr" },
    ],
  },
};
  ...
  const generic = [
    {
      ...
      a: `Le neuf beneficie generalement de taux reduits (~${(
        +input.neuf_pct || 2
    ...
    },
    {
      ...
      a: "Comptez generalement 8 a 12 semaines entre compromis et signature.",
    },
  ];
