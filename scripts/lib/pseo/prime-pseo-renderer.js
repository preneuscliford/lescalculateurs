...
function buildMetaSuffix(title, clusterLabel) {
  const type = detectPageType(title);
  return type === "guide"
    ? `Découvrez les règles de la ${clusterLabel} 2026 avec notre guide basé sur les sources officielles.`
...
<html lang="fr">
  <head>
    ...
    <title>${renderText(scenario.title)} ${buildTitleSuffix(scenario.title, "Prime d'Activité")}</title>
    <meta name="description" content="${renderAttributeText(scenario.description)} ${buildMetaSuffix(scenario.title, "Prime d'Activité")}" />
    <meta name="robots" content="index,follow" />
    <meta name="google-adsense-account" content="ca-pub-2209781252231399" />
    <link rel="canonical" href="${canonicalUrl}" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="${renderAttributeText(scenario.title)} ${buildTitleSuffix(scenario.title, "Prime d'Activité")}" />
    <meta property="og:description" content="${renderAttributeText(scenario.description)} ${buildMetaSuffix(scenario.title, "Prime d'Activité")}" />
    <meta property="og:url" content="${canonicalUrl}" />
    <meta property="og:image" content="${FAVICON_OG_IMAGE}" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="${renderAttributeText(scenario.title)} ${buildTitleSuffix(scenario.title, "Prime d'Activité")}" />
    <meta name="twitter:description" content="${renderAttributeText(scenario.description)} ${buildMetaSuffix(scenario.title, "Prime d'Activité")}" />
