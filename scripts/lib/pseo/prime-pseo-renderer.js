...
<html lang="fr">
  <head>
    ...
    <title>${renderText(scenario.title)} – Simulation Prime d'Activité 2026 | Les Calculateurs</title>
    <meta name="description" content="${renderAttributeText(scenario.description)} Estimez votre Prime d'activité 2026 gratuitement avec notre simulateur basé sur les barèmes CAF officiels." />
    <meta name="robots" content="index,follow" />
    <meta name="google-adsense-account" content="ca-pub-2209781252231399" />
    <link rel="canonical" href="${canonicalUrl}" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="${renderAttributeText(scenario.title)} – Simulation Prime d'Activité 2026 | Les Calculateurs" />
    <meta property="og:description" content="${renderAttributeText(scenario.description)} Estimez votre Prime d'activité 2026 gratuitement avec notre simulateur basé sur les barèmes CAF officiels." />
    <meta property="og:url" content="${canonicalUrl}" />
    <meta property="og:image" content="${FAVICON_OG_IMAGE}" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="${renderAttributeText(scenario.title)} – Simulation Prime d'Activité 2026 | Les Calculateurs" />
    <meta name="twitter:description" content="${renderAttributeText(scenario.description)} Estimez votre Prime d'activité 2026 gratuitement avec notre simulateur basé sur les barèmes CAF officiels." />
