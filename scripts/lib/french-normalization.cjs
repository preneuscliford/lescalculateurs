...
const WHOLE_TEXT_REPLACEMENTS = [
  ...
  [
    /Ce cas couvre l'intention familiale avec enfant pour éviter la cannibalisation des scénarios sans enfant\./gi,
    "Ce cas montre l'impact d'un enfant sur l'estimation, par rapport aux cas sans enfant.",
  ],
  [/pour eviter la cannibalisation/gi, "pour éviter de répéter des cas déjà traités"],
  [/cannibalisation/gi, "doublon de contenu"],
  [/Cette page capte l'intention/gi, "Cette page répond à la question"],
  [/Cette page sert l'intention/gi, "Cette page répond à la question"],
  [/Cette page couvre l'intention/gi, "Cette page traite le cas"],
  [/Cette page couvre une intention/gi, "Cette page traite une situation"],
