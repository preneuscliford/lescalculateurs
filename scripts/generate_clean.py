...
SIMULATEUR_TYPES = [
    ('aah', 'AAH'), ('asf', 'ASF'), ('are', 'ARE'), ('rsa', 'RSA'),
    ('plus.value', 'Plus-value'), ('plusvalue', 'Plus-value'), ('apl', 'APL'),
    ('impot', 'Impôt'), ('notaire', 'Notaire'), ('prime.activite', 'Prime'),
    ('prime activite', 'Prime'), ('ik', 'IK'), ('kilometrique', 'IK'),
    ('taxe.fonciere', 'Taxe'), ('taxe fonciere', 'Taxe'), ('taxe', 'Taxe'),
    ('pret.immobilier', 'Prêt'), ('pret immobilier', 'Prêt'), ('pret', 'Prêt'),
    ('salaire', 'Salaire'), ('brut.net', 'Salaire'), ('brut net', 'Salaire'),
    ('charge.copropriete', 'Charges'), ('charge copropriete', 'Charges'), ('charges', 'Charges'),
    ('crypto', 'Crypto'), ('bitcoin', 'Crypto'), ('foncier', 'Foncier'),
]
