export const aplPilotScenarios = [
  ...
  },
  {
    ...
    "description": "Estimation indicative APL 2026 pour une personne seule au chômage avec loyer moyen : ~312 EUR par mois dans ce scénario type.",
    ...
    "faq": [
      {
        ...
        "answer": "Une personne seule ou un foyer au chômage peut parfois conserver ou ouvrir un droit si le logement est éligible et si les ressources retenues par la CAF restent modestes. Estimation indicative ? vérifier sur caf.fr."
      },
      {
        "question": "Quel montant d'APL pour une personne au chômage avec loyer moyen en 2026 ?",
        "answer": "Dans ce scénario type, l'estimation indicative tourne autour de 312 EUR par mois. Le montant final dépend du loyer retenu, de la zone, des indemnités chômage et des autres ressources du foyer."
      },
      {
        "question": "Les indemnités chômage sont-elles prises en compte pour l'APL ?",
        "answer": "Oui, les indemnités chômage peuvent être retenues dans le calcul. C'est pourquoi deux situations de chômage proches peuvent donner des résultats différents selon les montants réellement pris en compte."
      },
      {
        "question": "L'APL au chômage suffit-elle pour payer le loyer ?",
        "answer": "Rarement ? elle seule. L'APL peut réduire le reste ? charge, mais elle ne remplace pas un budget logement complet. Il faut vérifier le montant final sur caf.fr."
      },
      {
        "question": "O? vérifier son APL au chômage apr?s cette estimation ?",
        "answer": "Le bon rréflexe est d'ouvrir le simulateur APL complet avec vos paramêtres réels, puis de vérifier le résultat final sur caf.fr avec votre dossier exact."
      }
    ],
    "briefEnhancements": {
      "metaTitle": "Estimation APL 2026 : chômage et loyer moyen (~312 EUR)",
      "metaDescription": "Estimation indicative APL 2026 pour une personne au chômage avec loyer moyen : ~312 EUR par mois. Utilisez notre simulateur complet et vérifiez sur caf.fr.",
      "directAnswer": "Estimation indicative : ~312 EUR par mois pour une personne seule au chômage avec loyer moyen en 2026.",
      "directAnswerDetails": "Le montant final dépend du loyer retenu, de la zone, des indemnités chômage réellement prises en compte et de votre situation administrative. Vérifiez toujours le résultat sur caf.fr.",
      "methodSteps": [
        {
          "title": "Sources utilis?es",
          "description": "Cette estimation repose sur le moteur APL du site et doit être rapproch?e des informations publi?es par la CAF et Service-Public."
        },
        {
        ...
        },
        {
          ...
          "description": "Le montant réel peut évoluer selon les indemnités chômage retenues, le loyer plafonn?, la zone exacte et les autres ressources déclarées."
        }
      ]
    }
  },
  ...
  },
  {
    ...
    "description": "Estimation indicative APL 2026 pour une personne seule au SMIC avec loyer moyen : ~144 EUR par mois dans ce scénario type.",
    "summary": "Cette page vise une variante de requête très proche du pattern gagnant d?j? test? par Google.",
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Dans ce scénario type, l'estimation indicative tourne autour de 144 EUR par mois. Le montant final dépend du loyer retenu, de la zone et des ressources réellement prises en compte."
      },
      {
        "question": "Le SMIC suffit-il ? faire tomber l'APL ? zéro ?",
        "answer": "Pas automatiquement. Tout dépend du loyer, de la zone et des ressources retenues par la CAF. Un loyer plus bas ou plus haut peut faire varier le résultat."
      },
      {
        "question": "Pourquoi deux personnes seules au SMIC peuvent-elles avoir une APL différente ?",
        "answer": "Parce que le niveau exact du loyer retenu, la zone géographique, les autres revenus et la période de r?férence peuvent modifier le calcul final."
      },
      {
        "question": "Comment vérifier cette estimation APL au SMIC ?",
        "answer": "Le plus utile est d'ouvrir le simulateur APL complet avec votre loyer réel, puis de vérifier votre résultat final sur caf.fr avant toute démarche."
      }
    ],
    "briefEnhancements": {
      "metaTitle": "APL au SMIC seul : estimation indicative 2026 (~144 EUR)",
      "metaDescription": "Estimation indicative APL 2026 pour une personne seule au SMIC : ~144 EUR par mois dans ce scénario type. Ouvrez le simulateur complet et vérifiez sur caf.fr.",
      "directAnswer": "Estimation indicative : ~144 EUR par mois pour une personne seule au SMIC avec loyer moyen en 2026.",
      "directAnswerDetails": "Le montant final dépend du loyer retenu, de la zone, des ressources réellement prises en compte et de votre situation administrative. Vérifiez toujours sur caf.fr.",
      "methodSteps": [
        {
          "title": "Sources utilis?es",
          "description": "Cette estimation est calculée avec le moteur APL du site et doit être recoup?e avec les informations officielles de la CAF."
        },
        {
          "title": "Hypothèse standard du scénario",
        ...
        {
          "title": "Marge de variation",
          "description": "Le résultat réel peut varier selon le loyer plafonn?, la zone exacte, les autres revenus du foyer et la période retenue par la CAF."
        }
      ]
    }
  },
  ...
  },
  {
    ...
    "description": "Estimation indicative APL 2026 pour une famille avec 3 enfants : ~87 EUR par mois dans ce scénario type.",
    "summary": "Cette page prolonge naturellement les signaux d?j? vus sur les familles avec enfants et la requête g?nérique autour de l'APL avec enfants.",
    ...
    "faq": [
      {
        ...
        "answer": "Dans ce scénario type, l'estimation indicative tourne autour de 87 EUR par mois. Le montant final dépend du loyer retenu, de la zone, des ressources du foyer et de la composition familiale exacte."
      },
      {
        "question": "Avec trois enfants, l'APL monte-t-elle toujours fortement ?",
        "answer": "Pas toujours. La prèsence de trois enfants peut rendre le calcul plus favorable, mais le niveau global de revenus du foyer et le loyer plafonn? restent ddécisifs."
      },
      {
        "question": "Un logement plus grand augmente-t-il automatiquement l'APL ?",
        "answer": "Pas automatiquement, car le plafond de loyer limite la part réellement retenue. Un logement plus cher peut donc augmenter le reste ? charge sans faire monter l'aide au même rythme."
      },
      {
        "question": "Pourquoi vérifier le résultat d'APL famille sur caf.fr ?",
        "answer": "Parce que la CAF tient compte de la situation réelle du foyer, du logement, des ressources retenues et des éventuelles aides d?j? perées. L'estimation affich?e ici reste indicative."
      },
      {
        "question": "Comment affiner cette estimation pour une famille avec 3 enfants ?",
        "answer": "Le plus simple est d'ouvrir le simulateur APL complet avec votre loyer réel, votre zone et vos revenus actuels, puis de vérifier le résultat final sur caf.fr."
      }
    ],
    "briefEnhancements": {
      "metaTitle": "APL famille 3 enfants : estimation indicative 2026 (~87 EUR)",
      "metaDescription": "Estimation indicative APL 2026 pour une famille avec 3 enfants : ~87 EUR par mois. Ouvrez le simulateur complet et vérifiez le montant final sur caf.fr.",
      "directAnswer": "Estimation indicative : ~87 EUR par mois pour une famille avec 3 enfants en 2026, dans ce scénario type.",
      "directAnswerDetails": "Le montant final dépend du loyer retenu, de la zone, des ressources du foyer et de la composition familiale exacte. Vérifiez toujours sur caf.fr.",
      "methodSteps": [
        {
          "title": "Sources utilis?es",
          "description": "Cette estimation repose sur le moteur APL du site et doit être compar?e aux informations officielles de la CAF et de Service-Public."
        },
        {
          "title": "Hypothèse standard du scénario",
        ...
        {
          "title": "Marge de variation",
          "description": "Le montant réel peut varier selon le loyer plafonn?, la zone exacte, la composition du foyer retenue et les autres ressources prises en compte."
        }
      ]
    }
  },
